...
/* Inicializamos dos matrices de 10 * 10 ya que es la cantidad de espacios máxima que
	...
	*/
	int mat1[10][10], mat2[10][10],resul[10][10],tam,eleg,i,j,k,h=0,val,ran,det=0,inte=1,sum=0,c,f;
...
int main(int argc, char** argv) {
	...
	while(ciclo){
		...
		cout<<"Que tamaño quiere que la matriz tenga? (1 - 10)"<<endl;
		cin>>tam;
		if(tam>10 || tam<1)
